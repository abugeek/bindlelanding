        ...
        <div>
            ...
            <div className="privacy-policy-container">
                ...
                <ul>
                    ...
                    <li>
                        <strong>Application</strong> refers to Bindle, the software program provided by the Company.
                    </li>
                    <li>
                        <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Bindle.
                    </li>
                    <li>
                ...
                <p>
                    The Company will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period of time, except when this data is used to strengthen the security or to improve the functionality of Our Service, or We are legally required to retain this data for longer periods.
                ...
                <ul>
                    ...
                    <li>
                        By visiting this page on our website: <a href="https://www.bindle.uz/privacy-policy" style={{ color: 'blue', textDecoration: 'underline' }}>
                            https://www.bindle.uz/privacy-policy
                        </a>
                    </li>
                </ul>
            </div>
